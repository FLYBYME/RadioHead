...
public:
    ...
    typedef enum
    {
		Bw125Cr45Sf128 = 0, //128ms
		Bw500Cr45Sf128,     //32ms
		Bw31_25Cr48Sf512,   //2414ms
		Bw125Cr48Sf4096,    //3785ms
		sf128cr45bw125,		//128ms
		sf128cr45bw250,		//65ms
		sf128cr45bw500,		//32ms
		sf128cr48bw125,		//193ms
		sf128cr48bw250,		//97ms
		sf128cr48bw500,		//49ms
		sf512cr45bw125,		//409ms
		sf512cr45bw250,		//204ms
		sf512cr45bw500,		//103ms
		sf512cr48bw125,		//604ms
		sf512cr48bw250,		//302ms
		sf512cr48bw500,		//151ms
		sf2048cr45bw125,	//1388ms
		sf2048cr45bw250,	//695ms
		sf2048cr45bw500,	//347ms
		sf2048cr48bw125,	//2023ms
		sf2048cr48bw250,	//1012ms
		sf2048cr48bw500,	//506ms
    } ModemConfigChoice;
    ...
    RH_RF95(uint8_t slaveSelectPin, uint8_t interruptPin, SPIClass& spi);
